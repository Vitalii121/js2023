...
createDiv.innerText = 'lorem ipsum.';
...
for (const coursesAndDurationArrayElement of coursesAndDurationArray) {
    ...
    div.innerText = `title - ${coursesAndDurationArrayElement.title}. month Duration - ${coursesAndDurationArrayElement.monthDuration}`
